...
public class LoginTemplate extends JFrame {
    ...
    public void crearObjetosDecoradores(){
        ...
        iFondo = new ImageIcon("Clase6/resources/img/fondo.png");
        iLogo = new ImageIcon("Clase6/resources/img/logo.png");
        iUsuario = new ImageIcon("Clase6/resources/img/usuario.png");
        iClave = new ImageIcon("Clase6/resources/img/clave.png");
        iPunto = new ImageIcon("Clase6/resources/img/punto.png");
        iFacebook = new ImageIcon("Clase6/resources/img/facebook.png");
        iTwitter = new ImageIcon("Clase6/resources/img/twitter.png");
        iYoutube = new ImageIcon("Clase6/resources/img/youtube.png");
        iSvg = new ImageIcon("Clase6/resources/img/imagen.png");
    }
